function [tone] = CreateToneBalance(tonefrequency, toneduration, samplingrate, attenuation, noise, sidebias)

if nargin < 6 || isempty(sidebias)
    sidebias = 0;
end
...
tone = [tone*(0.5-sidebias/2); tone*(0.5+sidebias/2)];
