function [noise] = CreateNoiseBalance(beta, noiseduration, samplingrate, attenuation, sidebias)
...
noise = [noise*(0.5-sidebias/2); noise*(0.5+sidebias/2)];
